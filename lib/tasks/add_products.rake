...
task add_products_in_db: :environment do
    f = File.open("/home/ads/Project/React_On_Rails/backend/app/assets/images/cup.jpg", 'rb')
    cupBin = Base64.encode64(f.read)
    f = File.open("/home/ads/Project/React_On_Rails/backend/app/assets/images/fork.jpg", 'rb')
    forkBin = Base64.encode64(f.read)
    f = File.open("/home/ads/Project/React_On_Rails/backend/app/assets/images/glass.jpeg", 'rb')
    glassBin = Base64.encode64(f.read)
    f = File.open("/home/ads/Project/React_On_Rails/backend/app/assets/images/plates.jpeg", 'rb')
    platesBin = Base64.encode64(f.read)
    f = File.open("/home/ads/Project/React_On_Rails/backend/app/assets/images/spoons.jpeg", 'rb')
    spoonsBin = Base64.encode64(f.read)
    f = File.open("/home/ads/Project/React_On_Rails/backend/app/assets/images/jug.jpg", 'rb')
    jugBin = Base64.encode64(f.read)
    f = File.open("/home/ads/Project/React_On_Rails/backend/app/assets/images/thermos.jpg", 'rb')
    thermosBin = Base64.encode64(f.read)
    f = File.open("/home/ads/Project/React_On_Rails/backend/app/assets/images/kettle.jpg", 'rb')
    kettleBin = Base64.encode64(f.read)
    f = File.open("/home/ads/Project/React_On_Rails/backend/app/assets/images/salt_pepper_bottles.jpg", 'rb')
